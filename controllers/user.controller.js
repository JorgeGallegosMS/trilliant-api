...
module.exports = {
    ...
    create: async(req, res, next) => {
		try {
			...
			mailSender(user.email, welcomeHTML);
	...
	// 		const helpfulCount = await userService.updateHelpfulValue(action, reviewId, userId);
	// 		return sendJson({
	// 			res,
	// 			data: helpfulCount,
	...
	// 		const looksGreatCount = await userService.updateLooksGreatValue(action, reviewId, userId);
	// 		return sendJson({
	// 			res,
	...
	helpfulCountUpdate: async(req, res) => {
		try {
			...
			const helpfulCount = await userService.updateHelpfulCount(action, userId);
			return sendJson({
				res,
				data: helpfulCount,
				msg: 'Helpful value updated!'
	...
	looksGreatCountUpdate: async(req, res) => {
		try {
			...
			const looksGreatCount = await userService.updateLooksGreatCount(action, userId);
			return sendJson({
				res,
				data: looksGreatCount,
				msg: 'Looks great value updated!'
